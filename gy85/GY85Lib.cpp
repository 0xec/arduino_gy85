...
namespace XecSensor
{
    ...
    void GY85::ReadAccelerometor(int* ax, int* ay, int* az)
    {
        Wire.beginTransmission(ADXL345);      // start transmission to device
    ...
    void GY85::ReadCompass(int* cx, int* cy, int* cz)
    {
    ...
    void GY85::ReadGyro(int* gx, int* gy, int* gz)
    {
        Wire.beginTransmission(ITG3200);
        Wire.write(0x1B);
        Wire.endTransmission();
